...
public class ArmSubsystem extends SubsystemBase {
        ...
        if (Config.armAvailable) {
            ...
            if (calibrated) {
                ...
                if (newDesiredPosition > armPositionToEncoderPosition(Config.armPositionIntakeStowedLimit) &&
                        newDesiredPosition < armPositionToEncoderPosition(Config.maxArmPosition)) {
    ...
    /**
     * Outputs only the arm position. Broken out because this should always appear on the dashboard.
     *
     */
    public void outputArmPositionToDashboard() {
