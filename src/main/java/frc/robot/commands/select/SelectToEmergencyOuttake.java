...
import frc.robot.commands.groups.ToEmergencyOuttakeCommandGroup;
...
public class SelectToEmergencyOuttake extends SelectCommand3309 {
    public SelectToEmergencyOuttake(IntakeSubsystem intake, IndexerSubsystem indexer, ShooterSubsystem shooter, ArmSubsystem arm, DriveSubsystem drive, CtrlPanelSubsystem manipulator) {
        super(() -> {
            if (RobotContainer.getRobotState() == RobotContainer.RobotState.INIT_INTAKE ||
                ...
                return new ToEmergencyOuttakeCommandGroup(intake, indexer, shooter, arm, drive, manipulator);
            } else {
                //do nothing
