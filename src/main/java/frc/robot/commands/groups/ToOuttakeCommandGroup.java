...
public class ToOuttakeCommandGroup extends SequentialCommandGroup {
    public ToOuttakeCommandGroup(Integer trenchArmPosition, IntakeSubsystem intake, IndexerSubsystem indexer, ShooterSubsystem shooter, ArmSubsystem arm, DriveSubsystem drive, CtrlPanelSubsystem manipulator) {
        addCommands(
                ...
                new SwitchToOuttake(intake, shooter),
